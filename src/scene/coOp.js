class coOp extends Phaser.Scene{
    constructor(){
        super("coOp");
    }
    ...
    create(){
        ...
        //rocket
        this.p1Rocket = new Rocket(this, game.config.width/2, game.config.height -borderUISize-borderPadding, 'rocket', false);
        this.p1Rocket.isPlayer2(false);
        this.p2Rocket = new Rocket(this,game.config.width/3, game.config.height - borderUISize-borderPadding, '2PRocket', true);
        this.p2Rocket.isPlayer2(true);
    ...
    shipExplode(ship){
        ...
        //separate var for bonus time, this var should be in the update let timer definition
        bonusTimer += 10;
        this.p1Score += ship.points;
        this.scoreLeft.text = this.p1Score;
        this.sound.play('explosion0' + ((Math.floor(Math.random()*4))+1).toString());
    }
}
